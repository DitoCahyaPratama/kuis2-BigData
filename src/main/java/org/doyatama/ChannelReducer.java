...
public final class ChannelReducer extends Reducer<Text, Text, Text, NullWritable> {
    ...
    public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        for (Text x : values) {
            ...
            try {
                ...
                commentCountsSum += commentCountEntry;
            } catch (NumberFormatException ex) {
                // Do nothing
            }
        }
        context.write(new Text(format("%s,%s,%s,%s,%s", key, viewsSum, likesSum, dislikesSum, commentCountsSum)), null);
    }
}